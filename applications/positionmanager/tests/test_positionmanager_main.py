...
from internal.money import Money

from applications.positionmanager.src.positionmanager.clients import AlpacaClient
from applications.positionmanager.src.positionmanager.main import application
...
class TestCreatePositionsEndpoint(unittest.TestCase):
    @patch("applications.positionmanager.src.positionmanager.main.AlpacaClient")
    @patch("applications.positionmanager.src.positionmanager.main.DataClient")
    ...
    def test_open_position_success(
        ...
        with (
            patch(
                "applications.positionmanager.src.positionmanager.clients.pa.py_buffer"
            ),
            patch(
                "applications.positionmanager.src.positionmanager.clients.pa.ipc.RecordBatchStreamReader"
            ),
            patch(
                "applications.positionmanager.src.positionmanager.main.pl.DataFrame"
            ) as mock_pl_dataframe,
            patch(
                "applications.positionmanager.src.positionmanager.main.PortfolioOptimizer"

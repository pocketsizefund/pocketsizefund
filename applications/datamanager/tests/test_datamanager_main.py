...
from internal.dates import Date

from applications.datamanager.src.datamanager.main import application, get_metrics
...
class TestDataManagerModels(unittest.TestCase):
    ...
    def test_date_with_date(self) -> None:
        date_value = date(2023, 1, 1)
        date_with_value = Date(date=date_value)
        assert date_with_value.date == date_value

    def test_date_string_parsing(self) -> None:
        date_with_string = Date(date="2023-01-01")  # type: ignore
        assert date_with_string.date == date(2023, 1, 1)
...
class TestEquityBarsEndpoints(unittest.TestCase):
    ...
    @patch("applications.datamanager.src.datamanager.main.duckdb")
    ...
    @patch("applications.datamanager.src.datamanager.main.S3Client")
...
class TestFetchEquityBarsEndpoint(unittest.TestCase):
    @patch("applications.datamanager.src.datamanager.main.PolygonClient")
    @patch("applications.datamanager.src.datamanager.main.pl.DataFrame")

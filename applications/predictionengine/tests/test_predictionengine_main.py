...
from applications.predictionengine.src.predictionengine.main import application
...
class TestCreatePredictionsEndpoint(unittest.TestCase):
    @patch("applications.predictionengine.src.predictionengine.main.requests.get")
    def test_create_predictions_success(
        ...
        with (
            patch(
                "applications.predictionengine.src.predictionengine.main.fetch_historical_data"
            ) as mock_fetch_data,
            patch(
                "applications.predictionengine.src.predictionengine.main.load_or_initialize_model"
            ) as mock_load_model,
            patch(
                "applications.predictionengine.src.predictionengine.main.get_predictions"

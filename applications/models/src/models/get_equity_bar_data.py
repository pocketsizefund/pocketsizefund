...
def get_polygon_equity_bar_data_as_csv(start_date: date, end_date: date) -> None:
        ...
        daily_equity_bars = [
            EquityBar(
                ...
                timestamp=datetime.fromtimestamp(
                    timestamp=cast("int", agg.timestamp) / 1000,
    ...
    equity_bars_dataframe = pl.DataFrame(all_daily_equity_bars)

    equity_bars_dataframe.write_csv(file="polygon_equity_bars.csv")

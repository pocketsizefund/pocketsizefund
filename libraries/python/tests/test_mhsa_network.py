from internal.mhsa_network import MultiHeadSelfAttentionNetwork
...
def test_multi_head_attention_single_sequence() -> None:
    attention = MultiHeadSelfAttentionNetwork(heads_count=2, embedding_size=16)
...
def test_multi_head_attention_longer_sequences() -> None:
    attention = MultiHeadSelfAttentionNetwork(heads_count=4, embedding_size=64)
